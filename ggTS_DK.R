...
ggTS_DK <- function(
  ...
  # isopycnal labels 
  # (works only if the isopycnals cross through the right edge of the plat area ...
  # ... which is the case for the in the South China Sea, for which this funcion was written,
  # ... but is not the case in the example data file)
